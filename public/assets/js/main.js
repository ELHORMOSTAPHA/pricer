(function ($) {
                ...
                $n_item
                    .on('mouseenter', (e) => {
                        ...
                        gsap.ticker.add(() => {
                            ...
                            const dt =
                                1.0 -
                                Math.pow(1 - speed, gsap.ticker.deltaRatio());
                        ...
                        if ($n_item.hasClass('hovering')) {
                            ...
                            $('.ms-cc_p .cursor-view, .cursor-text-holder').css(
                                'width',
                                'calc(4em + ' + text_h + 'px)'
                            );
    ...
    function ms_header_menu() {
        if ($.exists('.js-main-header__nav-trigger')) {
            var mainHeader =
                document.getElementsByClassName('js-main-header')[0];
            if (mainHeader) {
                var trigger = mainHeader.getElementsByClassName(
                        'js-main-header__nav-trigger'
                    )[0],
                    nav = mainHeader.getElementsByClassName(
                        'js-main-header__nav'
                    )[0];
    ...
    function ms_menu_default_mobile() {
        ...
        $(document).on(
            'click',
            '.is_mobile .navbar-nav > .menu-item-has-children > a',
            function (e) {
                //   e.preventDefault();
    ...
    function ms_lightbox($scope) {
        $(document).ready(function () {
            if ($('#galleryContainer').length > 0) {
                console.log(
                    '#galleryContainer is found, initializing gallery...'
                );
                var $scope = $('#galleryContainer');
    ...
    function gsapScrollingText() {
        $(document).ready(function () {
            let scrollingTextOne =
                document.getElementsByClassName('scrollingText');
    ...
    function ms_menu_mokko_button() {
        ...
        $(document).ready(function () {
            ...
            // Back
            $('#primary-menu-button .sub-menu').prepend(
                '<li class="menu-back"><a>Back</a></li>'
            );
            ...
            function menuOut(child_back) {
                ...
                next_width = parent_back
                    .parent('.menu-item')
                    .parent()
                    .outerWidth();
                next_height = parent_back
                    .parent('.menu-item')
                    .parent()
                    .outerHeight();
    ...
    function ms_theme_mode() {
        if ($.exists('.ms_theme_mode')) {
            ...
            $(s).on('click', function () {
                ...
                var newTheme =
                    $('body').attr('data-theme') == 'light' ? 'dark' : 'light';
    ...
    $(document).ready(function () {
        function ms_accordion_widget($scope) {
            ...
            function createAnimation(element) {
                ...
                const minusElement = element.querySelector(
                ...
                const timeline = gsap
                    ...
                    .fromTo(
                        ...
                        {
                            autoAlpha: hasSwitching ? 0 : 1,
                            duration: 0.2,
                            rotation: hasSwitching ? 0 : '180_cw',
                            ease: 'none',
                        },
                        0
                    )
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function initSwiper() {
            var el_material = document.querySelector(
            ...
            var simulateTouch =
                el_material.getAttribute('data-simulatetouch') === 'on';
            var loop = el_material.getAttribute('data-loop') === 'on';
            var delay =
                parseInt(el_material.getAttribute('data-delay')) || 3000;
            var slides = parseInt(el_material.getAttribute('data-spv')) || 1;
            var slides_t =
                parseInt(el_material.getAttribute('data-spv-t')) || slides;
            var slides_m =
                parseInt(el_material.getAttribute('data-spv-m')) || slides;
            var space = parseInt(el_material.getAttribute('data-space')) || 0;
            var space_t =
                parseInt(el_material.getAttribute('data-space-t')) || space;
            var space_m =
                parseInt(el_material.getAttribute('data-space-m')) || space;
            ...
            if (
                effect === 'material' &&
                typeof SwiperMaterial !== 'undefined'
            ) {
            ...
            var swiper = new Swiper(el_material, {
                ...
                on: {
                    init: function () {
                        ...
                        if (activeSlide) {
                            var firstSlideChars =
                                activeSlide.querySelectorAll('.char');
                    ...
                    slideChangeTransitionEnd: function () {
                        ...
                        if (activeSlide) {
                            var charsEnd =
                                activeSlide.querySelectorAll('.ms-sc--t .char');
                            if (charsEnd.length) {
